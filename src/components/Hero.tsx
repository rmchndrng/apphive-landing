...
export const Hero = () => {
  return (
    <div className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-b from-sky-50 to-white py-16">
      <div className="absolute inset-0 w-full h-full bg-grid-black/[0.02] bg-grid-16" />
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-blue-600 mb-6 animate-float">
            Build Apps with AI
          </h1>
